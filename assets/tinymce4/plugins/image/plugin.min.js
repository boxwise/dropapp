		...
		var generalFormItems = [
			{
				...
				label: 'Choose image',
				autofocus: true,
				classes: 'hideinputfield',
				onchange: srcChange
			},
			{
				name: 'preview',
				type: 'container',
				html: '<div style="width: 100%; height: 200px; text-align: left;"><img src="'+data.src+'" id="imagepreview" style="'+data.styleExtend+'max-height: 200px; max-width: 100%;" /></div>'
			},
			imageListCtrl
		];
