 ...
 */
tinymce.PluginManager.add('insertwhitepaper', function(editor, url) {
	// Add a button that opens a window
	editor.addButton('insertwhitepaper', {
		text: '',
		icon: 'text',
		tooltip: 'Insert whitepaper download',
		onclick: function() {
			// Open window with a specific url
			editor.windowManager.open({
				title: 'Insert whitepaper download',
				url: '/flip/insertwhitepaper/index.php',
				width: 600,
				height: 100,
				buttons: [
					{
