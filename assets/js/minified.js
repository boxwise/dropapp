...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=5e05c7c4c45c606de33e)
 * Config saved to config.json and https://gist.github.com/5e05c7c4c45c606de33e
 */
...
(function($) {
	$.extend($.validator.messages, {
		...
		iban: "Please fill in a valid IBAN.",
		dateNL: "Please fill in a valid date.",
		phoneNL: "Please fill in a valid Dutch Phone number.",
		mobileNL: "Please fill in a valid Dutch Mobile phone number.",
		postalcodeNL: "Please fill in a valid Dutch postalcode.",
		bankaccountNL: "Please fill in a valid Dutch bankaccount number.",
    ...
    var getValue = function($field) {
      ...
      switch (type) {
        ...
        case 'radio':
          ...
          break;
        case 'select':
          if($field.val()) val = $field.val().toString();
          break;
        default:
          val = $field.val();
      }
