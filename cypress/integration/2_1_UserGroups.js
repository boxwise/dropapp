...
const TestUserGroup_User = "BrowserTestUserGroup_User";
...
const CoordinatorAvailableFunctions = [];
const UserAvailableFunctions = [];
...
describe('Create usergroups (admin)', () => {
    ...
    it('Prevent usergroup with users deletion', () => {
