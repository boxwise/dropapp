<?php
    ...
    if ($ajax) {
        ...
        $cms_users_lower_level_query = 'SELECT u.*, NOT u.is_admin AS visible, g.label AS usergroup, 0 AS preventdelete, 0 as disableifistrue
			FROM cms_users AS u
