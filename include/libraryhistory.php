<?php
    ...
    if (!$ajax) {
        ...
        $cmsmain->assign('title', 'History for '.db_value('SELECT CONCAT(booktitle_en,IF(booktitle_ar!="",CONCAT(" - ",booktitle_ar),""),IF(author!="",CONCAT(" (",author,")"),"")) FROM library WHERE id = :id', ['id' => $_GET['id']]));
