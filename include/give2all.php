		...
		foreach($people as $person) {
			...
			if($f['parent_id']==0) {
				...
				if($_SESSION['camp']['resettokens']){
					db_query('INSERT INTO transactions (people_id,description,drops,transaction_date,user_id) VALUES (:people_id,:description,:drops,NOW(),:user_id)',array('people_id'=>$person,'description'=>"Reset of remaining tokens (cycle description - " . $_POST['description'] . ")",'drops'=>(-1) * $currentdrops,'user_id'=>$_SESSION['user']['id']));
					$currentdrops = 0;
				}
