<?php
	...
	addfield('number', 'Delete inactive beneficiaries', 'delete_inactive_users', array('tab'=>'beneficiaries','width'=>2,'tooltip'=>'Beneficiaries without activity in Boxwise will be deleted. Deleted beneficiaries will remain visible in the Deleted tab in the Beneficiaries page.'));
	addfield('number', 'Days to keep deleted persons', 'daystokeepdeletedpersons', array('tab'=>'beneficiaries','width'=>2,'tooltip'=>'Deleted beneficiaries will remain visible in the Deleted tab in the beneficiaries page and will be completely deleted after a while. Here you can define how long they will remain in the Deleted list.'));
