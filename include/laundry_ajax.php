<?php
	...
	$element['field'] = '<h2 class="light">This family has <span class="number">'.multiple($adults,'adult','adults').'</span> and <span class="number">'.multiple($children,'child','children').'</span> and is entitled to <span class="number">'.multiple(ceil((0.5*$adults)+(0.5*children)),'washing machine slot','washing machine slots').'</span> every cycle.</h2>';
