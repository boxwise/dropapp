<?php
    ...
    if ('out' == $data['status']) {
        ...
        array_unshift($people, ['value' => -1, 'label' => 'Somebody else', 'disabled' => 0]);

        addfield('select', 'Find person', 'people_id', ['required' => true, 'multiple' => false, 'options' => $people, 'onchange' => 'toggleLibraryComment()']);
