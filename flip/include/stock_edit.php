<?
	...
	if($data['qr_id']){
		...
		addfield('html', '', '<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=http://'.$_SERVER['HTTP_HOST'].$settings['rootdir'].'/flip/scan.php?barcode='.$qr.'" /><br /><br />', array('aside'=>true, 'asidetop'=>true));
	}
