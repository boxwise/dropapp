...
define('lang_Confirm_del','Are you sure you want to delete this file? This file could be in use.');
define('lang_All','All');
...
define('lang_Confirm_Folder_del','Are you sure to delete the folder and all the elements in it? The files could be in use.');
