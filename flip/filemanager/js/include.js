...
function apply_img(file,external){
    ...
    if (external!=""){
		...
		var imgpreview = $('#imagepreview', window_parent.document);
		$(imgpreview).attr("src", base_url+path+file);
...
function close_window() {
	if ($('#popup').val()==1) {
		...
		if (typeof parent.jQuery !== "undefined" && parent.jQuery) {						
			if (typeof parent.jQuery.fancybox !== "undefined" && parent.jQuery.fancybox) {				
			...
			if (typeof parent.$.fancybox !== "undefined" && parent.$.fancybox) {
