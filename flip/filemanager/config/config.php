...
require('flip.php');	
$locale = db_value('SELECT locale FROM languages WHERE code = "'.$settings['cms_language'].'"');
...
$upload_dir = '/content/original/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../content/original/'; // relative path from filemanager folder to upload folder (with final /)
...
$default_language 	= ($locale) ? $locale : 'en_GB'; //default language file name
...
$image_max_width  = ($settings['filemngr_maxwidth']) ? $settings['filemngr_maxwidth'] : 0;
$image_max_height = ($settings['filemngr_maxheight']) ? $settings['filemngr_maxwidth'] : 0;
...
*******************/
$aviary_active 	= true;
$aviary_key 	= "6137a12ba008c0e5";
$aviary_secret	= "f3adfb0807e6201b";
$aviary_version	= 3;
$aviary_language= 'en';
...
$fixed_path_from_filemanager            = array('../../content/icon/','../../content/thumb/','../../content/large/'); //fixed path of the image folder from the current position on upload folder
$fixed_image_creation_name_to_prepend   = array(''); //name to prepend on filename
$fixed_image_creation_to_append         = array(''); //name to append on filename
$fixed_image_creation_width             = array(20,80,200); //width of image (you can leave empty if you set height)
$fixed_image_creation_height            = array(20,80,200); //height of image (you can leave empty if you set width)
*/
...
$relative_path_from_current_pos         = array('icon/','thumb/','large/'); //relative path of the image folder from the current position on upload folder
...
$relative_image_creation_width          = array(20,80,200); //width of image (you can leave empty if you set height)
$relative_image_creation_height         = array(20,80,200); //height of image (you can leave empty if you set width)
*/
