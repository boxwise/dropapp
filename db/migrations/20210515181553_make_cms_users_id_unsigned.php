...
class MakeCmsUsersIdUnsigned extends AbstractMigration
{
    public function up()
    {
        ...
        $this->table('cms_users')
            ...
            ->changeColumn('created_by', 'integer', ['signed' => false])
            ->changeColumn('modified_by', 'integer', ['signed' => false])
            ->save()
        ;
        ...
        $this->table('stock')
            ...
            ->changeColumn('ordered_by', 'integer', ['signed' => false])
            ->changeColumn('picked_by', 'integer', ['signed' => false])
