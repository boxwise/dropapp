...
class ActionPermissions extends AbstractSeed
{
    ...
    public function run(): void
    {
        ...
        $this->execute('UPDATE cms_functions SET action_permissions = "view_stockroom" WHERE id=116');
        $this->execute('UPDATE cms_functions SET action_permissions = "generate_market_schedule" WHERE id=111');
        $this->execute('UPDATE cms_functions SET action_permissions = "manage_tokens" WHERE id=92');
        $this->execute('UPDATE cms_functions SET action_permissions = "manage_tokens" WHERE id=124');
        ...
        $this->execute('UPDATE cms_functions SET action_permissions = "view_inventory" WHERE id=160');
        ...
        $this->execute('UPDATE cms_functions SET action_permissions = "list_sales" WHERE id=127');
        ...
        $this->execute('UPDATE cms_functions SET action_permissions = "lend_books" WHERE id=147');
        ...
        $this->execute('UPDATE cms_functions SET action_permissions = "manage_beneficiaries" WHERE id=150');
        ...
        $this->execute('UPDATE cms_functions SET action_permissions = "be_god" WHERE id=50');
        $this->execute('UPDATE cms_functions SET action_permissions = "be_god" WHERE id=124');
        $this->execute('UPDATE cms_functions SET action_permissions = "be_god" WHERE id=156');
