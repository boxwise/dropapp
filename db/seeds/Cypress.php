...
class Cypress extends AbstractSeed
{
    ...
    public function run()
    {
        ...
        $this->execute("INSERT INTO `cms_users` (`id`, `pass`, `naam`, `email`, `is_admin`, `lastlogin`, `lastaction`, `created`, `created_by`, `modified`, `modified_by`, `resetpassword`, `language`, `deleted`, `cms_usergroups_id`, `valid_firstday`, `valid_lastday`) VALUES
        	...
        	(100000002,'bf13b44feae208fc808b1d6b2266edb7','BrowserTestUser_User', 'user@user.co',0,'0000-00-00 00:00:00','0000-00-00 00:00:00','2119-07-10 08:11:31',1,NULL,NULL,NULL,2,'0000-00-00 00:00:00',100000000,'0000-00-00','0000-00-00'),
        	...
        	(100000006,'bf13b44feae208fc808b1d6b2266edb7','BrowserTestUser_UserWithNoPermissions', 'noPermissions@noPermissions.co',0,'0000-00-00 00:00:00','0000-00-00 00:00:00','2019-07-10 08:11:31',1,NULL,NULL,NULL,2,'0000-00-00 00:00:00',100000003,'0000-00-00','0000-00-00'),
