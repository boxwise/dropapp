<div class="info-aside" id="people_id_selected">{$data['test']}
	...
	{if (isset($data['approvalsigned']) && $data['approvalsigned'] == FALSE)}<button class="btn btn-default" type="button"><span class="fa fa-edit warning 3"> Privacy declaration</span></button>{/if}
