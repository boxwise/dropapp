<div class="info-aside" id="people_id_selected">
	...
	{if $smarty.session.camp['food']}<p class="familycredit">Max food: <i class="fa fa-tint"></i> <span id="foodcredit" data-food-credit="{$data['fooddrops']}">{$data['fooddrops']}</span> drops</p>
	{/if}
