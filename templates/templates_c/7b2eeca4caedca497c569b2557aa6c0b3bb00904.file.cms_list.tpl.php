<?php /* Smarty version Smarty-3.1.18, created on 2017-02-22 13:38:04
         compiled from "/Users/bart/Websites/themarket/library/templates/cms_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:149196790158a4bd93866ec5-36455256%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b2eeca4caedca497c569b2557aa6c0b3bb00904' => 
    array (
      0 => '/Users/bart/Websites/themarket/library/templates/cms_list.tpl',
      1 => 1487757473,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '149196790158a4bd93866ec5-36455256',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_58a4bd939ac259_27220693',
  'variables' => 
  array (
    'listconfig' => 0,
    'title' => 0,
...
<?php if ($_valid && !is_callable('content_58a4bd939ac259_27220693')) {function content_58a4bd939ac259_27220693($_smarty_tpl) {?><div class="row">
...
" for="group-select-1"><input id="group-select-1" type="checkbox" class="group-select"></label>
					...
					<li class="items-selected-dependent">
						<div class="btn-group">
							...
							<?php if ($_smarty_tpl->tpl_vars['listconfig']->value['allowshowhide']) {?><button data-operation="show" class="action-show start-operation btn btn-default btn-sm" href="#"><i class="fa glyphicon fa-eye"></i> <?php echo $_smarty_tpl->tpl_vars['listconfig']->value['show'];?>
</button>
...
" class="action-delete start-operation btn btn-sm confirm btn-danger" href="#"><i class="fa fa-trash-o"></i> <?php echo $_smarty_tpl->tpl_vars['listconfig']->value['delete'];?>
</button><?php }?>

							<?php if ($_smarty_tpl->tpl_vars['listconfig']->value['allowcopy']) {?><button data-operation="copy" data-placement="top" class="action-copy start-operation btn btn-sm btn-default" href="#"><i class="fa fa-copy"></i> <?php echo $_smarty_tpl->tpl_vars['listconfig']->value['copy'];?>
</button><?php }?>
...
" class="item <?php if (isset($_smarty_tpl->tpl_vars['row']->value['visible'])&&!$_smarty_tpl->tpl_vars['row']->value['visible']) {?>item-hidden<?php }?> level-<?php echo $_smarty_tpl->tpl_vars['row']->value['level'];?>
							...
							<?php if (!$_smarty_tpl->tpl_vars['row']->value['preventedit']&&($_smarty_tpl->tpl_vars['listconfig']->value['allowedit'][$_smarty_tpl->tpl_vars['row']->value['level']]||!isset($_smarty_tpl->tpl_vars['listconfig']->value['allowedit']))) {?>item-clickable<?php }?>
