    ...
    <script src="{$settings['rootdir']}/assets/js/js.php?v4"></script>
    ...
    <script src="{$settings['rootdir']}/assets/js/magic.js?v=4"></script>
    <script src="{$settings['rootdir']}/assets/js/custom.js?v=4"></script>    
  </body>
</html>