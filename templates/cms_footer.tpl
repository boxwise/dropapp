    ...
    <script src="{$settings['rootdir']}/assets/js/js.php?v5"></script>
    ...
    <script src="{$settings['rootdir']}/assets/js/magic.js?v=5"></script>
    <script src="{$settings['rootdir']}/assets/js/custom.js?v=5"></script>    
  </body>
</html>