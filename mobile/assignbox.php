...
WHERE (NOT s.deleted OR s.deleted IS NULL) AND s.product_id = p.id AND l.id = s.location_id AND l.camp_id = '.$_SESSION['camp']['id'].' AND l.visible AND (s.qr_id IS NULL) ');
