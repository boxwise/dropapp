<?php
    ...
    redirect('?message=Box '.$box['box_id'].' contains now '.$newitems.'x '.$box['product'].'.&messageAnchorText=Go back to this box&messageAnchorTarget=boxid&messageAnchorTargetValue='.$box['box_id']);
