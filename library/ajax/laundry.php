<?php
	...
	if(!$data['approvalsigned']) $element['field'] .= "<br /><div class='warningbox2'>Please have the familyhead read and sign the approval form for storing and processing their data.</div><br />";
