...
{if $data['fulllabel']}
<div class="boxlabel">
	<div class="boxlabel-qr"><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://market.drapenihavet.no/{$settings['rootdir']}/scan.php?barcode={$d['hash']}" /></div>
...
<div class="boxlabel-small">
	<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=http://{$smarty.server.HTTP_HOST}{$settings['rootdir']}/scan.php?barcode={$d['hash']}" />
</div>
{/if}
{/foreach}
